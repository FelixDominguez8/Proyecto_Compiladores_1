...
public class MiniPascalLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "COMMENT", "WS", "CONSTCHAR", "CONSTSTR", "VAR", "BEGIN", "END", 
			"PROGRAM", "WRITE", "READ", "IF", "THEN", "ELSE", "WHILE", "DO", "FOR", 
			"TO", "DOWNTO", "INTEGER", "CHAR", "STRING", "BOOLEAN", "ARRAY", "OF", 
			"TRUE", "FALSE", "NOT", "AND", "OR", "PLUS", "MINUS", "MULT", "DIV", 
